...
// Параметры:
//   ИнформационнаяБаза - Строка - Имя или идентификатор информационной базы
//   Фильтр - Структура - фильтр структура отключений (по умолчанию неопределено)
//						  * Ключ - имя поля для поиска
//						  * Значение - массив значений фильтра
//
Процедура ОтключитьСеансыИнформационнойБазыПоФильтру(Знач ИнформационнаяБаза, Знач Фильтр = Неопределено) Экспорт
